...
def criar_testes_motorola():
    ...
    testes.append(TestCase(
        ...
        validation_point_action="CAM_A006",
        context_preserving=True,
        ...
        actions=[
            ...
            Action(
                id="CAM_A004",
                description="Verificar modo Foto está selecionado por padrão",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
            ...
            Action(
                id="CAM_A005",
                description="Verificar visualização da câmera está estável e focada",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
            ...
            Action(
                id="CAM_A007",
                description="Verificar miniatura da foto aparece na galeria",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
    ...
    testes.append(TestCase(
        ...
        validation_point_action="CAM_A010",
        context_preserving=True,
        parent_test_id="MOTO_CAM_001",
        actions=[
            Action(
                id="CAM_A008",
                description="Verificar câmera está aberta (herda do pai)",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'camera_app_open'},
                postconditions={'camera_ready'},
                estimated_time=1.0,
                priority=1,
            ),
            Action(
                id="CAM_A009",
                description="Localizar e tocar no seletor de modo para alternar para Retrato",
                action_type=ActionType.NAVIGATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
            ...
            Action(
                id="CAM_A010",
                description="Posicionar pessoa no enquadramento e verificar detecção",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
            ...
            Action(
                id="CAM_A011",
                description="Pressionar botão de captura para tirar foto em modo retrato",
                action_type=ActionType.CREATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
            ...
            Action(
                id="CAM_A012",
                description="Aguardar processamento do efeito bokeh",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'portrait_captured'},
                postconditions={'bokeh_processing'},
                estimated_time=2.0,
                priority=1,
            ),
            Action(
                id="CAM_A013",
                description="Verificar efeito bokeh foi aplicado corretamente na foto",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'bokeh_processing'},
    ...
    testes.append(TestCase(
        ...
        dependencies={'MOTO_CAM_001'},
        validation_point_action="CAM_A020",
        context_preserving=True,
        parent_test_id="MOTO_CAM_001",
        actions=[
            Action(
            ...
            Action(
                id="CAM_A015",
                description="Localizar e tocar no seletor de modo para alternar para Vídeo",
                action_type=ActionType.NAVIGATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
                preconditions={'camera_ready'},
            ...
            Action(
                id="CAM_A016",
                description="Acessar configurações de vídeo",
                action_type=ActionType.NAVIGATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'video_mode_active'},
                postconditions={'video_settings_open'},
                estimated_time=2.0,
                priority=1,
            ),
            Action(
                id="CAM_A017",
                description="Selecionar resolução 1080p (Full HD) nas configurações",
                action_type=ActionType.MODIFICATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
                preconditions={'video_settings_open'},
            ...
            Action(
                id="CAM_A020",
                description="Gravar vídeo por 10 segundos mantendo estabilidade",
                action_type=ActionType.CREATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
            ...
            Action(
                id="CAM_A021",
                description="Tocar no botão de parar para finalizar gravação",
                action_type=ActionType.CREATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
            ...
            Action(
                id="CAM_A022",
                description="Aguardar processamento e salvamento do vídeo",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'recording_stopped'},
                postconditions={'video_processing'},
                estimated_time=3.0,
                priority=1,
            ),
            Action(
                id="CAM_A023",
                description="Abrir galeria e verificar vídeo salvo",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'video_processing'},
    ...
    testes.append(TestCase(
        ...
        dependencies={'MOTO_SETUP_001'},
        validation_point_action="WIFI_A011",
        context_preserving=True,
        ...
        actions=[
            ...
            Action(
                id="WIFI_A004",
                description="Verificar seção WiFi está visível na lista de configurações",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
            ...
            Action(
                id="WIFI_A007",
                description="Tocar na rede WiFi 2.4GHz desejada da lista",
                action_type=ActionType.CREATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
            ...
            Action(
                id="WIFI_A011",
                description="Aguardar autenticação e verificar conexão estabelecida",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
    ...
    testes.append(TestCase(
        ...
        validation_point_action="WIFI_A016",
        context_preserving=True,
        parent_test_id="MOTO_WIFI_001",
        actions=[
            Action(
                id="WIFI_A013",
                description="Verificar WiFi está conectado (herda do pai)",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'wifi_connected'},
                postconditions={'wifi_ready'},
                estimated_time=1.0,
                priority=1,
            ),
            Action(
                id="WIFI_A014",
                description="Desbloquear dispositivo e localizar ícone do navegador Chrome",
                action_type=ActionType.NAVIGATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
                preconditions={'wifi_ready'},
                postconditions={'chrome_icon_visible'},
                estimated_time=2.0,
                priority=1,
            ),
            Action(
                id="WIFI_A015",
                description="Tocar no ícone para abrir navegador Chrome",
                action_type=ActionType.NAVIGATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
                preconditions={'chrome_icon_visible'},
            ...
            Action(
                id="WIFI_A016",
                description="Verificar barra de endereço está visível e pronta",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'browser_open'},
                postconditions={'address_bar_ready'},
                estimated_time=1.0,
                priority=1,
            ),
            Action(
                id="WIFI_A017",
                description="Tocar na barra de endereço e digitar URL (google.com)",
                action_type=ActionType.CREATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
                preconditions={'address_bar_ready'},
                postconditions={'url_entered'},
                estimated_time=4.0,
                priority=1,
            ),
            Action(
                id="WIFI_A018",
                description="Confirmar navegação e iniciar carregamento",
                action_type=ActionType.NAVIGATION,
                impact=ActionImpact.PARTIALLY_DESTRUCTIVE,
                preconditions={'url_entered'},
            ...
            Action(
                id="WIFI_A019",
                description="Aguardar carregamento completo da página",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'website_loading'},
                postconditions={'page_loading'},
                estimated_time=3.0,
                priority=1,
            ),
            Action(
                id="WIFI_A020",
                description="Verificar página carregada completamente e conteúdo visível",
                action_type=ActionType.VERIFICATION,
                impact=ActionImpact.NON_DESTRUCTIVE,
                preconditions={'page_loading'},
